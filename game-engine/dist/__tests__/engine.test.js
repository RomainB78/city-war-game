...
describe('Game Engine', () => {
    ...
    it('should initialize game state correctly', () => {
        const state = (0, engine_1.createInitialState)('g1', 'CODE123', players);
    ...
    it('should prevent capital exchange', () => {
        ...
        expect(() => {
            (0, engine_1.performExchangeAction)(state, 'VILLE_IMPERIALE', {
    ...
    it('should swap bastions during valid exchange', () => {
        ...
        const nextState = (0, engine_1.performExchangeAction)(state, 'VILLE_IMPERIALE', {
            sourceCityId: 'saint_germain',
    ...
    it('should trigger capital relocation when attacking capital', () => {
        ...
        const nextState = (0, engine_1.initiateAttack)(state, 'CHATOU', {
        ...
        const postRelocationState = (0, engine_1.relocateCapital)(nextState, 'VILLE_IMPERIALE', {
            cityId: 'le_pecq',
    ...
    it('should enforce attack validations', () => {
        ...
        expect(() => {
            (0, engine_1.initiateAttack)(state, 'CHATOU', {
                sourceCityId: 'chatou',
        ...
        expect(() => {
            (0, engine_1.initiateAttack)(oneBastionState, 'CHATOU', {
                sourceCityId: 'chatou',
        ...
        expect(() => {
            (0, engine_1.initiateAttack)(weakBastionState, 'CHATOU', {
                sourceCityId: 'chatou',
